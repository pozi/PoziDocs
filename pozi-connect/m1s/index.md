...
If you have not already done so, set up a weekly repeat order for both datasets at [DELWP DataShare](https://datashare.maps.vic.gov.au/){:target="_blank"}.
...
Log on to [VES](https://ves.land.vic.gov.au/){:target="_blank"} and upload the spreadsheet file as per the [M1 Form Load Guide](https://ves.land.vic.gov.au/assets/documents/VES%20User%20Manual%20v1.2.pdf) [pdf].
